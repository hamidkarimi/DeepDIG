...
parser.add_argument("--decay-lr", type=float, required=False, default=0.99, help="The learning rate decay rate")
...
parser.add_argument("--weight-decay", type=float, required=False, default=0.00, help="The weight decay")
...
parser.add_argument("--dev-percent", type=float, required=False, default=0.2, help="Percentage of dev set")
